INSERT INTO AcuaticClub
(Nit,nombre,Direccion,Departamento,Paiz)
VALUES
('12345','AcuaticClub','C. AlbinaPatiño','CBBA','Bolivia');
...
-- INSERT INTO tutor
-- (CiTutor,idTipoTutor,primerNombre ,segundoNombre ,apellidoPaterno,apellidoMaterno ,numeroCelular,direccion ,Foto)
-- VALUES
-- ('123','3','maria','','gonzales','suarez','6847459','c.primero de mayo','foto');


INSERT INTO TipoNivel
(Nivel)
VALUES
('Inicial'),
('Basico'),
